...
const pillars = [
    ...
    },
    {
        ...
        metrics: [
            "mNPS, sNPS > 95%",
            "90% capability matrix done",
            "100% legal/financial readiness"
        ],
    ...
    <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white pb-20 pt-32 px-6 rounded-b-[3rem] shadow-xl relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto font-light">
                "E-Konsulta will win by being the <span className="font-semibold text-white">most reliable platform</span>, powered by a <span className="font-semibold text-white">strong and aligned team</span>, scaling profitably through <span className="font-semibold text-white">disciplined growth</span>."
            </p>
        </div>
    </div>
);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {pillars.map((pillar) => (
                <div key={pillar.id} className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-300">
                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 ${pillar.color} border-2`}>
                        {pillar.icon}
                    </div>
    ...
    return (
        <div className="bg-white border border-slate-200 rounded-xl p-5 hover:border-blue-300 transition-colors duration-200">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-full border ${getPillarColor(data.pillar)}`}>
                            {data.pillar}
                        </span>
                    </div>
...
const Dashboard = () => {
    ...
    const getIconForGroup = (grp) => {
        switch(grp) {
            case "Patient's Journey": return <Users className="w-4 h-4" />;
            case "Doctor's Journey": return <Stethoscope className="w-4 h-4" />;
            case "Internals": return <LayoutGrid className="w-4 h-4" />;
            case "Platform": return <Activity className="w-4 h-4" />;
            case "Finance": return <DollarSign className="w-4 h-4" />;
            case "Legal": return <FileText className="w-4 h-4" />;
            case "Strategic Partnerships": return <Briefcase className="w-4 h-4" />;
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-16">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h2 className="text-2xl font-bold text-slate-900">Operational Objectives</h2>
        ...
        <div className="min-h-screen bg-slate-50 pb-20 font-sans text-slate-900">
            ...
            <footer className="max-w-7xl mx-auto px-6 py-8 border-t border-slate-200 mt-12">
                <div className="flex flex-col md:flex-row justify-between items-center text-slate-400 text-sm">
                    <p>&copy; 2024 E-Konsulta Strategic Planning Division.</p>
